...
{
    /// <summary>
    /// Шестой сценарий. Достижение максимальной продуктивности насаждения для ведения лесопромышленной деятельности, путем рубок древесины по диаметру.
    /// </summary>
    internal class Activitiy6 : IActivitie
    {
        /// <summary>
        /// Мероприятие 1
        /// </summary>
        ...
        public Activitiy6(MyTable currentRow)
        {
        ...
        public void CalculateActivitie()
        {
            ...
            if (_totalPol > 0.5)
            {
                ...
                else if (_currentRow.D1 < 16)
                {
                    _mer1 = 581; // рубка ухода
                    switch (_totalPol)
                    {
                        case 0.6:
                            _prvb = 5;
